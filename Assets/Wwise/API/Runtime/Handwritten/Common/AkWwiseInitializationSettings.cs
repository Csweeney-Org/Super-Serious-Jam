...
public class AkWwiseInitializationSettings : AkCommonPlatformSettings
{
	...
	private static readonly string[] AllGlobalValues = new[]
	{
		...
		"UserSettings.m_SpatialAudioSettings.m_DiffractionFieldNodeBudget",
		"UserSettings.m_SpatialAudioSettings.m_MaxDiffractionPaths",
		"UserSettings.m_SpatialAudioSettings.m_MaxGlobalReflectionPaths",
		"UserSettings.m_SpatialAudioSettings.m_ReflectionPathSearchEffort",
		"UserSettings.m_SpatialAudioSettings.m_MaxDiffractionAngleDegrees",
		"UserSettings.m_SpatialAudioSettings.m_SmoothingConstantMs",
		"UserSettings.m_SpatialAudioSettings.m_TransmissionOperation",
